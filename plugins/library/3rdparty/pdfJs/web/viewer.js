...
var DEFAULT_URL = parent.eUrban.global.printform.url;
...
function getPDFFileNameFromURL(url) {
  ...
  return parent.eUrban.global.printform.filename || 'document.pdf';
}
  ...
  open: function pdfViewOpen(file, args) {
    ...
    var result = loadingTask.promise.then(
      ...
      function getDocumentError(exception) {
        ...
        document.getElementById('egova-msg').style.display = 'none';
...
function webViewerInitialized() {
  ...
  var cstyle = parent.eUrban.global.style;
  var con = document.getElementById('toolbarContainer');
  var findbar = document.getElementById('findbar');
  var promenu = document.getElementById('secondaryToolbar');
  if('black' === cstyle){
    document.getElementById('egova-msg').style.color = 'white';
  } else if('whiteblue' === cstyle){
    con.style.backgroundColor = '#3286E9';
    findbar.style.backgroundColor = '#3286E9';
    promenu.style.backgroundColor = '#3286E9';
  } else if ('whitegreen' === cstyle){
    con.style.backgroundColor = '#1C957E';
    findbar.style.backgroundColor = '#1C957E';
    promenu.style.backgroundColor = '#1C957E';
  } else if ('whitered' === cstyle) {
    con.style.backgroundColor = '#C84040';
    findbar.style.backgroundColor = '#C84040';
    promenu.style.backgroundColor = '#C84040';
  }
  ...
  if (file && file.lastIndexOf('file:', 0) === 0) {
    ...
    //     }
    //     PDFViewerApplication.open(ints);
    //   }
    // }
    try {
      xhr.open('GET', file);
  ...
  if (file) {
    document.getElementById('egova-msg').style.display = 'block';
    PDFViewerApplication.open(file);
  }
  //PDFViewerApplication.open(parent.eUrban.global.printform.pdfData);
}
