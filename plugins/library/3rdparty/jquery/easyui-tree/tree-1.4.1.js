...
(function($) {
	...
	function _4(_5) {
		...
		$(_5).unbind().bind("mouseover", function(e) {
			...
			if (tt.hasClass("tree-hit")) {
				...
				if (tt.hasClass("tree-checkbox") && !_6.checkdisable) { //eUrban code liyabin
	...
	function _11(_12) {
		...
		var _15 = _13.tree;
		var _dropFlag = false;
		var _22, _23, _24, _21_;
		_13.disabledNodes = [];
		_14.dnd = true;
		_15.find("div.tree-node").draggable({ //eUrban code liyabin
			disabled: false,
			// revert: true,
			// cursor: "pointer",
			...
			// 	p.html("<span class=\"tree-dnd-icon tree-dnd-no\">&nbsp;</span>" + $(_16.target).html());
				// p.hide();
			// 	return p;
			// },
			// deltaX: 15,
			...
			over: function(e, _1d) {
				...
				if (_14.onDragOver.call(_12, this, _1b(_1d.draggable)) == false) {
					// _1c(_1d.helper, false);
					$(this).removeClass("tree-node-append tree-node-top tree-node-bottom");
					$(this).droppable("disable");
					_13.disabledNodes.push(this);
				}
			...
			out: function(e, _20) {
				// _1c(_20.helper, false);
				$(this).removeClass("tree-node-append tree-node-top tree-node-bottom");
				_14.onDragLeave.call(_12, this, _1b(_20.draggable));
			},
			drop: function(e, _21) {
				_22 = this;
				// var _23, _24;
				...
				if (_14.onBeforeDrop.call(_12, _22, _1b(_21.draggable), _24) == false) {
					$(this).removeClass("tree-node-append tree-node-top tree-node-bottom");
					return;
				}
				_dropFlag = true;
				_21_ = _21.draggable;
				// _23(_21.draggable, _22, _24);
				$(this).removeClass("tree-node-append tree-node-top tree-node-bottom");
			}
		});
		...
		function _1c(_28, _29) {
			var _2a = _28.find("span.tree-dnd-icon");
		...
		render: function(_11b, ul, data) {
			...
			function _11d(_11e, _11f) {
				...
				for (var i = 0; i < _11f.length; i++) {
					...
					//eUrban code yangbo add title attribte
					if(opts.title){
						cc.push("<span class=\"tree-title\" title=\""+  opts.formatter.call(_11b, item) +"\">" + opts.formatter.call(_11b, item) + "</span>");
					} else {
		...
		loader: function(_121, _122, _123) {
			...
			$.ajax({
				...
				success: function(data) {
					_122($.isArray(data) ? data : data.treeList);
				},
				error: function() {
