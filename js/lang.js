let txt_lang = {
    'zh-cn': {
        ...
        layer_base:'基础图层',
        layer_hainan:'海南测绘局',
        layer_2018_map:'2018电子地图服务',
        layer_2018_note:'2018电子地图注记服务',
        layer_2015_wmts:'2015年影像服务',
        layer_2016_wmts:'2016年影像服务',
        layer_2017_wmts:'2017年影像服务',
        layer_2018_wmts:'2018年影像服务',
        layer_note:'影像注记服务',
        layer_road:'道路数据',
        layer_state_road:'国道分布',
        layer_province_road:'省道分布',
        layer_railway:'铁路分布',
        layer_bridge:'桥梁分布',
        layer_house:'房屋数据',
        layer_farm:'房子水田分布',
        ...
        layer_village:'村庄分布',
        layer_reduce:'减灾数据',
        layer_relocation_site:'安置点分布',
        layer_collapse:'地灾崩塌分布',
        layer_shelter:'避难场所分布',
        layer_rescue_station:'救助站分布',
        layer_population:'人口数据',
        layer_population_density:'人口密度分布',
        ...
        typhoon_forecast:'预测路径点',
        typhoon_path:'预测台风路径',
        typhoon_center:'中心位置',
        typhoon_air_pressure:'中心气压',
        typhoon_wind_speed:'最大风速',
        ...
        affected_farm:'受影响水田',
        affected_village:'受影响村庄',
        affected_road:'受影响道路',
        affected_total:'总计'
    },
    'en-au': {
        title: 'Hainan Remote Sensing Disaster Decision Support System',
        title_min: 'Disaster Information Integration',
        ...
        menu_typhoon_path: 'Hurricane&Rainfall',
        menu_pos_typh_data:'Hurricane Path',
        menu_rain: 'Rainfall Distribution',
        menu_extra: 'Flood',
        menu_pre_wat_tif:'Pre-disaster Image',
        menu_pos_wat_tif:'Post-disaster Image',
        menu_pre_water: 'Pre-disaster Water',
        menu_pos_water: 'Post-disaster Water',
        menu_flood: 'Flood Extraction',
        menu_affected:'Disaster Analysis',
        menu_affected_bridge:'Affected Bridge',
        menu_affected_school:'Affected School',
        menu_affected_st:'Affected Paddyfield',
        menu_affected_village:'Affected Village',
        menu_affected_road:'Affected Road',
        menu_report: 'Evaluation Report',

        situation_sat: 'Overview of Satellites',
        satellite_gaofen: 'GaoFen',
        satellite_ziyuan: 'ZiYuan',
        satellite_shaobin: 'Sentinel',
        gaofen1: 'GaoFen1',
        satellite_height: 'Altitude',
        satellite_resolution: 'Resolution',
        satellite_return: 'RepeatCycle',
        satellite_time: 'Revisit',
        day:'day',

        layer_base:'Base Map',
        layer_hainan:'Geomatics Center of Hainan',
        layer_2018_map:'2018 Map',
        layer_2018_note:'2018 Map Annotation',
        layer_2015_wmts:'2015 Image',
        layer_2016_wmts:'2016 Image',
        layer_2017_wmts:'2017 Image',
        layer_2018_wmts:'2018 Image',
        layer_note:'Image Annotation',
        layer_road:'Road',
        layer_state_road:'National highway',
        layer_province_road:'Provincial highway',
        layer_railway:'Railway',
        layer_bridge:'Bridge',
        layer_house:'Buildings',
        layer_farm:'Farm',
        layer_school:'School',
        layer_village:'Village',
        layer_reduce:'Disaster Deduction',
        layer_relocation_site:'Relocation sites',
        layer_collapse:'Geological collapse sites',
        layer_shelter:'Shelter',
        layer_rescue_station:'Rescue station',
        layer_population:'Population',
        layer_population_density:'Population density',
        ...
        typhoon_forecast:'Predict path',
        typhoon_path:'Typhoon path',
        typhoon_center:'Center',
        typhoon_air_pressure:'Air pressure',
        typhoon_wind_speed:'Wind speed',
        ...
        affected_village:'Affected Village',
